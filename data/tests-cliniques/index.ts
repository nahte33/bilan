...
export const TESTS_MANUELS: TestClinique[] = [
  ...
  {
    id: "slump_test",
    nom: "Slump test (mise en tension neuroméningée)",
    regions: ["rachis_lombaire"],
    cible: "Radiculopathie lombaire / hernie discale (tension neurale)",
    technique: "Assis, enroulement progressif : flexion du tronc, flexion cervicale, extension du genou puis dorsiflexion ; reproduction des symptômes, sensibilisée/levée par la flexion cervicale.",
    precision: "Face à l'IRM (hernie discale) : Se ≈ 0,84, Sp ≈ 0,83 — plus SENSIBLE que le SLR (Se 0,52), légèrement moins spécifique.",
    interpretation: "Utile pour ÉLIMINER quand le SLR est négatif ; positif = argument de composante neurale.",
    sources: [{ label: "Majlesi J et al. J Clin Rheumatol 2008 · DOI 10.1097/RHU.0b013e31816b2f99 · PMID 18391677" }],
  },
  {
    id: "trendelenburg",
    nom: "Signe de Trendelenburg (abducteurs de hanche)",
    regions: ["hanche_aine"],
    cible: "Insuffisance / déchirure du moyen fessier",
    technique: "Appui unipodal ; chute du bassin du côté opposé (ou compensation du tronc) = positif. Tenir ≈ 30 s.",
    precision: "Pour la détection d'une déchirure du moyen fessier (IRM) : Se ≈ 73 %, Sp ≈ 77 % ; c'était le signe le plus fiable (kappa 0,68) parmi les 3 testés dans le GTPS.",
    interpretation: "Positif = argument d'atteinte des abducteurs / tendinopathie fessière (GTPS).",
    sources: [{ label: "Bird PA et al. Arthritis Rheum 2001 · DOI 10.1002/1529-0131(200109)44:9<2138::AID-ART367>3.0.CO;2-M · PMID 11592379" }],
  },
  {
    id: "wells_tvp",
    nom: "Score de Wells (probabilité clinique de thrombose veineuse profonde)",
    regions: ["cuisse", "genou", "cheville_pied"],
    cible: "Drapeau rouge : thrombose veineuse profonde (TVP)",
    technique: "Règle de décision additionnant des items cliniques (cancer actif, immobilisation, alitement/chirurgie récente, douleur sur trajet veineux, œdème du mollet > 3 cm, œdème godet, veines collatérales… −2 si diagnostic alternatif ≥ probable).",
    precision: "Stratifie la probabilité de TVP (faible/modérée/élevée) et guide, avec les D-dimères, le recours à l'écho-doppler. Règle de décision validée, non un test physique isolé.",
    interpretation: "⚠️ Devant un mollet suspect : ne pas masser, appliquer le score et orienter (D-dimères / écho-doppler).",
    sources: [{ label: "Wells PS et al. N Engl J Med 2003 · DOI 10.1056/NEJMoa023153 · PMID 14507948" }],
  },
  {
    id: "centralisation_mckenzie",
    nom: "Phénomène de centralisation (évaluation répétée type McKenzie)",
    regions: ["rachis_lombaire", "rachis_cervical"],
    cible: "Douleur d'origine discale / pronostic de la lombalgie",
    technique: "Mouvements répétés/positions maintenues ; observer si la douleur distale se « centralise » (remonte vers le rachis) ou se périphéralise.",
    precision: "La centralisation est un phénomène de bon pronostic et oriente le traitement par direction préférentielle ; sa fiabilité dépend d'un examinateur formé (Aina 2004).",
    interpretation: "Centralisation = favorable et guide la direction d'exercice ; périphéralisation = défavorable.",
    sources: [{ label: "Aina A et al. Man Ther 2004 (revue de la centralisation) · DOI 10.1016/j.math.2004.03.004 · PMID 15245707" }],
  },
  {
    id: "y_balance_sebt",
